    ...
    return (
        <div className="bioPageDiv">
            ...
            <div className="content-block">
                <img className='bio-image' src="/images/WesArcher.jpeg"></img>
            ...
            <div className="content-block">
                <img className='bio-image' src="/images/WesGhibli.jpeg"></img>
                <h3 className="text-block">
            ...
            <div className="content-block">
                <img className='bio-image' src="/images/WesSamuraiJack.jpeg"></img>
                <h3 className="text-block">
            ...
            <div className="content-block">
                <img className='bio-image' src="/images/Wes.jpeg"></img>
                <h3 className="text-block">
