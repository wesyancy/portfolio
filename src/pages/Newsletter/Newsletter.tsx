    ...
    return (
        <div className="newsPageDiv">
            ...
            <p>
                ...
                Substack. Focused on self-improvement, productivity, happiness
                and fulfillment, each issue highlights a single idea, providing
                readers with insight, examples, and actionable advice for its
                implementation.
                <br />
                <br />I started this newsletter in July of 2024 while beginning
            ...
            <p>
                Below are some screenshots to help you get a feel for the kind
                of content contained in the publication.
            </p>
